<section class="swiper RoomsSwiper relative">
    <div class="swiper-wrapper">
        ...
        <!-- Slide Navigation -->
    <div class="prevRoomEl absolute bottom-32 sm:bottom-16 right-[60%] sm:right-[40%] z-10 cursor-pointer w-fit" id="prev-room-btn">
    ...
    <div class="nextRoomEl absolute bottom-32 sm:bottom-16 right-1/3 z-10 cursor-pointer w-fit" id="next-room-btn">

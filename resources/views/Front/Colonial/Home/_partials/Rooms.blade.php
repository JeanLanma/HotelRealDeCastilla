<section class="swiper RoomsSwiper relative">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div class="flex flex-row-reverse justify-between items-start min-h-screen">
                ...
                <div class="w-1/2">
                    <div class="w-full h-screen">
                        <img class="w-full h-screen" src="{{asset('images/habitaciones/habitacion-doble-sencilla-02.jpg')}}" alt="Habitacion doble queen">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="swiper-slide">
            <div class="flex flex-row-reverse justify-between items-start min-h-screen">
                ...
                <div class="w-1/2">
                    <div class="w-full h-screen">
                        <img class="w-full h-screen" src="{{asset('images/habitaciones/habitacion-estandar-triple-03.jpg')}}" alt="Habitacion doble queen">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Slide Navigation -->
    <div class="prevRoomEl absolute bottom-16 right-[40%] z-10 cursor-pointer w-fit" id="prev-room-btn">
    ...
    <div class="nextRoomEl absolute bottom-16 right-1/3 z-10 cursor-pointer w-fit" id="next-room-btn">

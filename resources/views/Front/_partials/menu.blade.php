<header class="relative">
    <div class="absolute top-0 left-0 py-0 px-40 min-w-full flex justify-center {{ !request()->routeIs('home') ? 'bg-primary-blue' : '' }}">
        <div class="w-full max-w-7xl flex justify-between items-center relative top-0 left-0 py-0 2xl:px-12 sm:h-28">
            <div>
                <div class="bg-primary-blue h-[10.6rem] absolute -top-4 flex items-center rounded-b-[3rem]">
                    <a href="{{ route('home') }}" class="block w-[17rem] px-4">
            ...
            <div>
                <nav>
                    <ul class="flex justify-between gap-x-[3.2rem] text-white font-medium text-[1.2rem] leading-6">
